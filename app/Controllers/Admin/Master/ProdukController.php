...
class ProdukController extends BaseController
{
    public function index()
    {
        ...
        echo view('admin/master/produk/produk', $data);
...
public function edit_product($id)
{
    ...
    if (!$data['produk']) {
        ...
        return redirect()->to(base_url('admin/master/produk'))->with('error', 'Produk tidak ditemukan.');
    }
    ...
    public function update($id)
    {
        ...
        if ($this->request->getMethod() === 'post') {
            ...
            if ($this->validate($validationRules)) {
                ...
                // Redirect ke halaman daftar produk atau halaman lain yang sesuai
                return redirect()->to(base_url('admin/master/produk'))->with('success', 'Produk berhasil diupdate');
            }
        }
